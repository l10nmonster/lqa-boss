...
// then paths like 'viewer.html' are correct if viewer.html is also at /lqa-boss/viewer.html.
const urlsToCache = [
...
self.addEventListener('fetch', event => {
    ...
    if (urlsToCache.some(url => event.request.url.endsWith(url.startsWith('.') ? 'viewer.html' : url))) {
        event.respondWith(
